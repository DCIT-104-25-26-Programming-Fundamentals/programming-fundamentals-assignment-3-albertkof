...
function computeModulus(a, b) { return a % b; }
...
do {
    ...
    console.log("7. Quit");
    choice = parseInt(readlineSync.question("Select an operation (1-7): "));
    ...
    if (choice < 1 || choice > 7) {
        console.log("Error: Please select a valid option (1-7).");
        continue;
    }
    ...
    switch (choice) {
        ...
        case 5:
            if (num2 === 0) {
                ...
                console.log(`Result: ${num1} % ${num2} = ${computeModulus(num1, num2)}`);
            }
            break;
        case 6:
            console.log(`Result: ${num1} ** ${num2} = ${power(num1, num2).toFixed(2)}`);
            break;
    }
} while (choice !== 7);
